...
void Recognize::detectAndSave( Mat& img, CascadeClassifier& cascade,
...
void Recognize::sendMsg(QString msg1)
{
...
QImage Recognize::cvMat2QImage(const cv::Mat& mat)
{
...
bool Recognize::DeleteDirectory(const QString &path)
{
    if (path.isEmpty())
        return false;
